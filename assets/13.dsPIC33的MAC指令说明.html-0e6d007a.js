import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as u,c as r,d as o,e as n,w as e,a as l,b as s,f as v}from"./app-02156c45.js";const c="/blog/assets/blog_image/dsPIC/数字补偿器运算.png",_="/blog/assets/blog_image/dsPIC/数字格式_整数与小数.png",m="/blog/assets/blog_image/dsPIC/有符合小数格式.png",b="/blog/assets/blog_image/dsPIC/CORCON_内核控制寄存器.png",f="/blog/assets/blog_image/dsPIC/累加器正常饱和.png",C="/blog/assets/blog_image/dsPIC/MAC指令例子.png",g="/blog/assets/blog_image/dsPIC/MAC指令语法.png",x={},A=l("h1",{id:"dspic33的mac指令说明",tabindex:"-1"},[l("a",{class:"header-anchor",href:"#dspic33的mac指令说明","aria-hidden":"true"},"#"),s(" dsPIC33的MAC指令说明")],-1),h=l("p",null,"MAC（相乘并累加）指令常用于数字补偿器的运算。",-1),p=l("img",{src:c},null,-1),q=l("p",null,"dsPIC33中数字补偿器的运算经常使用的是Q格式，如Q15。",-1),V=l("img",{src:_},null,-1),Q=l("img",{src:m},null,-1),W=l("p",null,"MAC指令使用前都会先设置CORCON（内核控制寄存器）=0x00C0（为小数乘法，普通饱和模式）。",-1),H=l("img",{src:b},null,-1),P=l("img",{src:f},null,-1),B=l("img",{src:C},null,-1),N=l("img",{src:g},null,-1),I=v(`<p>使用Python验证MAC指令例子。</p><details class="hint-container details"><summary>详情</summary><div class="language-Python line-numbers-mode" data-ext="Python"><pre class="language-Python"><code>
