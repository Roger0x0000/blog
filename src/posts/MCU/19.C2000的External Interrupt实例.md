...
# C2000的External Interrupt实例

本节主要记录C2000的External Interrupt驱动实例。
...
<center>
<img src="/assets/blog_image/TMS320F28035/PIE_Block.png">
<center> 使用 PIE 块的中断多路复用 </center>
</center>


<center>
<img src="/assets/blog_image/TMS320F28035/PeripheralInterruptVectorTable.png">
<center> PIE 多路复用的外设中断矢量表 </center>
</center>
...
+ 实验现象：定时器0为100ms；外部中断为下降沿中断，按键按下时LED状态翻转。
